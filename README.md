...
| get_all_adsorption_result     | None                                                                                                                        | Obtain adsorption data for each component in each unit, including absolute and excess adsorption capacities                                                      | Dict, the keys are "{component_name}_absolute_unit", "{component_name}_excess_unit", "finished" and "warnings" |
